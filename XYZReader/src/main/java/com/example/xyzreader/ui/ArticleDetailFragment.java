...
public class ArticleDetailFragment extends Fragment implements
    ...
    private static final String SHOW_ALL_BUTTON_KEY = "show_all_button_key";
    ...
    private long itemId;
    private int scrollY;
    public boolean showAllButton = true;
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean(SHOW_ALL_BUTTON_KEY, showAllButton);
    ...
    private void applyBylineConfig() {
    ...
    private void applyLoadMoreConfig() {
        final String details = cursor.getString(ArticleLoader.Query.BODY);
        if (savedInstanceState != null) {
            showAllButton = savedInstanceState.getBoolean(SHOW_ALL_BUTTON_KEY, true);
        }
        if (showAllButton && details.length() > 150) {
            Spanned fromHtml = Html.fromHtml(details.substring(0, 150)
                    .replaceAll("(\r\n|\n)", "<br />"));
            ...
            showAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ArticleDetailFragment.this.showAllButton = false;
                }
            });
        } else {
            bodyView.setText(Html.fromHtml(details.replaceAll("(\r\n|\n)", "<br />")));
    ...
    private void applyMetaBarConfig() {
